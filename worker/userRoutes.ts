...
import type { ApiResponse, ProjectState, AuthUser, CodexItem } from '@shared/types';
export function userRoutes(app: Hono<{ Bindings: Env }>) {
    ...
    app.post('/api/auth/login', async (c) => {
        ...
        const user: AuthUser = { id: 'u1', username: username || 'Architect', role: 'admin', token: 'infinity-jwt' };
